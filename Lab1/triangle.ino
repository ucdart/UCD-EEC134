/*
Triangle wave and sync pulse generator to control a (0-5V input range) VCO for CWFM radar.
...
void loop()
{
  ...
  for (int a = 0; a <= 4080; a=a+4)// Rising edge of the triangle wave
  {
    outputValue = a;
  ...
  for (int a = 4080; a >= 4; a = a-4)// Falling edge of the triangle wave
  {
    outputValue = a;
    digitalWrite(10, LOW);
