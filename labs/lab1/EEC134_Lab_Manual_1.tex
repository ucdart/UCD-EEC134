...
\begin{enumerate}
	...
	\item To measure the filter response only, input a 3\,Vpp signal through R4 (at point 2 in Fig.~\ref{fig:lpf-sch})  and measure the output through R14 (at point 3 in Fig.~\ref{fig:lpf-sch}). Tabulate and plot the frequency response from 100\,Hz to 150\,kHz. What is the cutoff frequency of the filter?
