...
\section{Objectives}
The main objective of this lab is to understand the basic components of a typical embedded electronic system. To this end, we will build a simple system shown in Fig.~\ref{fig:lab1_system}. We will use a micro-controller and a digital-to-analog converter (DAC) to generate a triangle wave signal which will be filtered, digitized by an analog-to-digital converter (ADC), processed by another micro-controller, and displayed on an LCD display. 
