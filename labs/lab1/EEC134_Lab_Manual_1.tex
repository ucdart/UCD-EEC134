...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline \hline
		Pre-lab 1.1 & \due{Oct.~1st, 2018 } & pdf & ``prelab-1-1-YourName.pdf'' \\
		\hline
		Pre-lab 1.2 & \due{Oct.~8th, 2018} & pdf & ``prelab-1-2-YourName.pdf''\\
		\hline
		Pre-lab 1.3 & \due{Oct.~15th, 2018} & pdf & ``prelab-1-3-YourName.pdf''\\
		\hline
		Lab 1 report & \due{Oct.~22nd, 2018 } & pdf & ``lab-1-GroupName.pdf''\\
		\hline
		Lab 1 PCB design \& review reports & \due{Oct.~29th, 2018 } & pdf & ``pcb-1-report-GroupName.pdf''\\
		\hline
		Lab 1 PCB gerber files & \due{Oct.~29th, 2018 } & zip & ``pcb-1-design-GroupName.zip''\\
		\hline
		Lab 1 PCB test report & \due{Nov.~19th, 2018 } & pdf & ``pcb-1-test-GroupName.pdf''\\
		\hline
	\end{tabular}
