...
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{ 1.1} \\Due: \textcolor{red}{Sept. 25th, 2015}}  Please answer the following questions:
\begin{enumerate}[label=\alph*)]
	...
	\item What does \textit{SNR} mean for a DAC? What is the typical SNR for the Linear Technology LTC2641 DAC?
	
	\item What does \textit{THD} mean for an ADC? What is the typical THD for the Texas Instrument ?
	
	\item What does \textit{SINAD} mean for an ADC? What is the typical SINAD for the 
	
	\item What does \textit{ENOB} mean for an ADC? How is it calculated? What is the ENOB for the TI ?
	...
	If we pass the signal through an ideal low-pass filter that keeps only the first three harmonics (including the fundamental, that is, fundamental, 2nd harmonic, and 3rd harmonic), what would the filter output signal look like in the time domain?
