...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline
		Pre-lab 1.2 & \due{Oct.~6th, 2016} & pdf & ``prelab-1-2-GroupName.pdf''\\
		\hline
		Pre-lab 1.3 & \due{Oct.~13th, 2016} & pdf & ``prelab-1-3-YourName.pdf''\\
		\hline
		Lab 1 report & \due{Oct.~20th, 2016} & pdf & ``lab-1-YourName.pdf''\\
		\hline
		Lab 1 PCB design \& review reports & \due{Oct.~28th, 2016} & pdf & ``pcb-1-report-GroupName.pdf''\\
		\hline
...
\begin{enumerate}
	...
	\item The following items are due by \due{Oct.~28th, 2016}. Refer to Table.~\ref{tab:deliverables} for submission instructions. 
		\begin{itemize}
