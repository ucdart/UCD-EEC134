...
All items are to be submitted to the course email: eec134f2016@gmail.com.  
...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline \hline
		Pre-lab 1.1 & \due{Sept.~29th, 2016 } & pdf & ``prelab-1-1-YourName.pdf'' \\
		\hline
		Pre-lab 1.2 & \due{Oct.~6th, 2016} & pdf & ``prelab-1-2-YourName.pdf''\\
		\hline
		Pre-lab 1.3 & \due{Oct.~13th, 2016} & pdf & ``prelab-1-3-YourName.pdf''\\
		\hline
		Lab 1 report & \due{Oct.~20th, 2016} & pdf & ``lab-1-GroupName.pdf''\\
		\hline
		Lab 1 PCB design \& review reports & \due{Oct.~27th, 2016} & pdf & ``pcb-1-report-GroupName.pdf''\\
		\hline
		Lab 1 PCB gerber files & \due{Oct.~27th, 2016} & zip & ``pcb-1-design-GroupName.zip''\\
		\hline
		Lab 1 PCB test report & \due{Nov.~17th, 2016} & pdf & ``pcb-1-test-GroupName.pdf''\\
		\hline
	\end{tabular}
...
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{ 1.1} \\Due: \due{Sep.~29th, 2016}}  Please answer the following questions:
...
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{ 1.2} \\Due: \due{Oct.~6th, 2016}}  Please answer the following questions:
\begin{enumerate}[itemsep=0.1ex, label=\alph*)]
...
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{ 1.3} \\Due: \due{Oct.~13th, 2016}}  Please answer the following questions:
\begin{enumerate}[itemsep=0.1ex, label=\alph*)]
...
\begin{enumerate}
	...
	\item The following items are due by \due{Oct.~27th, 2016}. Refer to Table.~\ref{tab:deliverables} for submission instructions. 
		\begin{itemize}
	...
	\item After the PCB comes back, you will need to assemble the circuit and test it. The tests would be similar to what you have done in Measurement~\ref{sec:lm317}--\ref{sec:adc}. Test report for this PCB is due by \due{Nov.~17th, 2016}.
\end{enumerate}
