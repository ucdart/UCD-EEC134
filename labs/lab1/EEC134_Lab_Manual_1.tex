...
All items are to be submitted to the TA email (haowang@ucdavis.edu) by noon (12pm) of the due date. No late submissions are accepted. Don't even ask. 

Please following the file name format rigorously. Replace ``GroupName'' with your group's name. 
...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline
		Lab 1 PCB gerber files & \due{Oct.~23rd, 2015} & zip & ``pcb-1-design-GroupName.pdf''\\
		\hline
...
\textbf{Notes:}
\begin{enumerate}
	\item All due items are to be submitted in either PDF (documents) or zip (design files) format. 
	\item All items are to be submitted at the following link:
		\url{URL}
\end{enumerate}
