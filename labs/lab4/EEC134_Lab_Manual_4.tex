...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline
		\hline
		Pre-lab 4 & \due{Nov.~10th, 2016} & pdf & ``prelab-4-YourName.pdf''\\
				
		\hline
		Lab 4 report & \due{Nov.~17th, 2016} & pdf & ``lab-4-GroupName.pdf''\\
		\hline
	\end{tabular}
...
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{4} \\Due: \due{Nov.~10th, 2016}}
