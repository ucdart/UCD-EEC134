...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline \hline
		Pre-lab 2.1 & \due{Oct.~22nd, 2017} & pdf & ``prelab-2-1-YourName.pdf'' \\
		\hline
		Pre-lab 2.2 & \due{Oct.~29th, 2017} & pdf & ``prelab-2-2-YourName.pdf''\\
		\hline
		Lab 2 report & \due{Nov.~5th, 2017} & pdf & ``lab-2-GroupName.pdf''\\
		\hline
		PCB 2 design \& review reports & \due{Nov.~5th, 2017} & pdf & ``pcb-2-report-GroupName.pdf''\\
		\hline
		PCB 2 gerber files & \due{Nov.~5th, 2017} & zip & ``pcb-2-design-GroupName.zip''\\
		\hline
		PCB 2 test report & \due{Nov.~26th, 2017} & pdf & ``pcb-2-test-GroupName.pdf''\\
		\hline
		PCB 3 design \& review reports & \due{Nov.~12th, 2017} & pdf & ``pcb-3-report-GroupName.pdf''\\
		\hline
		PCB 3 gerber files & \due{Nov.~12th, 2017} & zip & ``pcb-3-design-GroupName.zip''\\
		\hline
		PCB 3 test report & \due{Dec.~3rd, 2017} & pdf & ``pcb-3-test-GroupName.pdf''\\
		\hline
	\end{tabular}
...
\newpage
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{2.1} }  
...
\reversemarginpar
\marginnote{\textbf{Pre-lab Assignment}\\\textbf{2.2} }  Please answer the following questions:
\begin{enumerate}[itemsep=0.1ex, label=\alph*)]
