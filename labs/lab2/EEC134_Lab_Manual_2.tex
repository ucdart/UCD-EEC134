...
\begin{table}[h]
	...
	\begin{tabular}{|m{1in}|l|m{0.45in}|m{2in}|}
		...
		\hline
		PCB 2 design \& review reports & \due{Nov.~11th, 2018} & pdf & ``pcb-2-report-GroupName.pdf''\\
		\hline
		PCB 2 gerber files & \due{Nov.~11th, 2018} & zip & ``pcb-2-design-GroupName.zip''\\
		\hline
		PCB 2 test report & \due{Dec.~2nd, 2018} & pdf & ``pcb-2-test-GroupName.pdf''\\
		\hline
	\end{tabular}
...
\begin{enumerate}
	...
	\item The following items are due by \due{Nov.~11th, 2018}. Refer to Table.~\ref{tab:deliverables} for submission instructions. 
		\begin{itemize}
	...
	\item After the PCB comes back, you will need to assemble the circuit and test it. The tests would be similar to what you have done in Measurement~\ref{sec:equipment}--\ref{sec:ip3}. Test report for this PCB is due by \due{Dec.~2nd, 2018}.
