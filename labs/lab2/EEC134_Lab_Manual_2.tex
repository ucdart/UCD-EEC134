...
\begin{enumerate}
	...
	\item The following items are due by \due{Nov.~3rd, 2016}. Refer to Table.~\ref{tab:deliverables} for submission instructions. 
		\begin{itemize}
	...
	\item After the PCB comes back, you will need to assemble the circuit and test it. The tests would be similar to what you have done in Measurement~\ref{sec:equipment}--\ref{sec:ip3}. Test report for this PCB is due by \due{Nov.~24th, 2016}.
...
\begin{enumerate}
	...
	\item The following items are due by \due{Nov.~10th, 2016}. Refer to Table.~\ref{tab:deliverables} for submission instructions. 
		\begin{itemize}
			\item A PCB design report to the TA. The design report should include the following:
				\begin{itemize}
					\item Bill of materials.
	...
	\item After the PCB comes back, you will need to assemble the circuit and test it. The main test is the attenuation level at various attenuation settings. Test report for this PCB is due by \due{Dec.~1st, 2016}.
