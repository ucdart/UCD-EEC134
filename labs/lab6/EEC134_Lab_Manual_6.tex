	...
	\begin{enumerate}
		...
		\item Try to refine your measurement results and answer the following questions. 
			\begin{enumerate}
				...
				\item Measure the Doppler characteristics of an object or machine that have exposed moving parts, such as a fan or a rotating bicycle wheel. 
