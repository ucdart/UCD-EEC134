...
\begin{enumerate}
	...
	\item Now move the components into the layout area. Do do this, you can:
		\begin{enumerate}
			...
			\item Let's tentatively arrange the components as shown in Fig.~\ref{fig:layout-iniital}. 
				\begin{figure}[hp]
					\centering
					\includegraphics[width=4in]{layout-initial}
	...
	\item In the last step we will generate the outline of the PCB. This is the physical boundary of the PCB. Fig.~\ref{fig:pcb-outline-example} illustrates an example PCB with a non-rectangular outline. 
		\begin{figure}[hp]
				\centering
				\includegraphics[width=3in]{pcb-outline-example}
	...
	\begin{figure}[hp]
		\centering
		\includegraphics[width=4.5in]{layout-final}
...
In reality, however, all components have parasitics due to their finite physical size and proximity to other components/circuits. These parasitics can be inductive, capacitive, and/or resistive. Fig. 
...
%TODO: add schematic screenshot from KiCad

\subsection{Component footprints}

\subsubsection{ADL5602 footprint}
%TODO: drawing ADL5602 footrpint
...
The Coilcraft 0603LS-NX has a recommended footprint in its datasheet (copied here in Fig. ). 
