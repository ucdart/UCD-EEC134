...
In recent years, \href{http://www.kicad-pcb.org/}{KiCad} has emerged as a popular open-source software package for designing and laying out PCBs. KiCad is available on all three major personal computer operating systems, Windows, Linux, and Mac OS. 
...
\begin{enumerate}
	...
	\item Once the fill zones have been defined, right click on anywhere in the main layout window and select ``Fill or Refill All Zones'' to create the copper fill. Fig.~\ref{fig:example2-layout-fill} shows the copper filled layout. Notice that the gap between the trace and the fill is uniform everywhere. This is because we set up only one fill zone. Setting up multiple fill zones will allow you to have multiple separations. 
...
\begin{itemize}
	...
	\item \href{http://deskthority.net/wiki/KiCAD_keyboard_PCB_design_guide}{KiCAD keyboard PCB design guide}
