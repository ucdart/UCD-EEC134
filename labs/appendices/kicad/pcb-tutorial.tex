...
%	\end{figure}
%	
%Later in this tutorial, we will show you how to implement such the CPWG in KiCad. 
%
%\subsubsection{Bending of Transmission Lines}
%
...
%
%Besides a less than perfect impedance matching, trace bends can introduce additional adverse effects such as dispersion. To see this, let's consider the bend shown in 
%
