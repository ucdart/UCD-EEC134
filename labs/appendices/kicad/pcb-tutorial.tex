...
\usepackage{url,graphicx,xcolor,enumitem, array,hyphenat,amssymb,booktabs,pdflscape,rotating,longtable}
\usepackage{hyperref}
\hypersetup{
	colorlinks=true,
	linkcolor=blue,
...
Fig.~\ref{fig:switch-footprint-final} shows the completed footprint drawing for the switch. 
	...
	\begin{figure}[hp]
		\centering
		\includegraphics[width=3in]{switch-footprint-final}
...
The footprint of the 16\,MHz crystal can be created manually from its datasheet. Given the practice we have done so far, it should be relatively straightforward to do. 
	\begin{figure}[hp]
		\centering
		\includegraphics[width=3.5in]{atmega328p-footprint-final}
		\caption{Completed footprint for the ATmega328P-PU microcontroller.}
		\label{fig:atmega328p-footprint-final}
	\end{figure}
