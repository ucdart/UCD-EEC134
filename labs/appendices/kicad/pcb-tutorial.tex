...
\url{http://deskthority.net/wiki/KiCAD_keyboard_PCB_design_guide}

\url{http://www.kicadlib.org/Fichiers/KiCad_Tutorial.pdf}

* KiCad footprint generator: \url{http://kicad.rohrbacher.net/quickmod.php}

* KiCad library management: \url{https://docs.google.com/document/d/1M38ByFyqnhwGo8b_jDDyBceyZtEGeaSAuQaP9REzWrU/edit}

* KiCad footprint management:
\url{http://mithatkonar.com/wiki/doku.php/kicad/footprint_management}

* Easier way to via stitching: \url{https://www.youtube.com/watch?v=Hp5ngKtl7S4}
